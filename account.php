...
<div class="col-8 mx-auto">
	<div class="row">
		...
		<div class="col-7 pt-3">
			...
			<div>
  	  	<form action="check2.php" method="GET" enctype="multipart/form-data">
			<textarea type="" name="post" placeholder="Что у вас нового?"></textarea> 
			<p data-toggle="modal" data-target="#exampleModal" class="text-black update">Добавить фотографию</p>
